...
1. **Semantic Search**: VectorRAG - Use embeddings and a vector index to find relevant functions, parameters, and data types.
2. **General Graph Query**: GraphRAG - Given the input, query the graph database for special nodes and relationships.
